...
test1 <- read.csv("GitHub/parlMICE/Simulation/sim4_1000.csv")
...
test2 <- read.csv("GitHub/parlMICE/Simulation/sim4_1000_zoom.csv")
...
postscript("GitHub/parlMICE/Simulation/Figure1.pdf", width = 16, height=5)
do.call(grid.arrange, c(list1, list(nrow = 1, ncol = 2)))
dev.off()

test3 <- read.csv("GitHub/parlMICE/Simulation/sim8_10000.csv")
...
test4 <- read.csv("GitHub/parlMICE/Simulation/sim8_10000_zoom.csv")
test4["ms"] <- seq(6, 24, 6)
...
postscript("GitHub/parlMICE/Simulation/Figure2.pdf", width = 16, height=5)
